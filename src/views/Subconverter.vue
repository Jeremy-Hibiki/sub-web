...
const gayhubRelease = import.meta.env.VITE_BACKEND_RELEASE;
const defaultBackend =
  import.meta.env.VITE_SUBCONVERTER_DEFAULT_BACKEND + "/sub?";
const shortUrlBackend = import.meta.env.VITE_MYURLS_API;
const configUploadBackend = import.meta.env.VITE_CONFIG_UPLOAD_API;
